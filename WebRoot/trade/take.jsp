...
<div id="main">
  ...
  <div id="text">
    ...
    <c:forEach items="${listLatest }" var="trade">
      <form:form id="form1" action="takeAdd.do" method="post">
      <c:forEach items="${listLogin }" var="user">
     		<form:hidden path="userid" value="${user.id }"/><br>
     	</c:forEach>
     	<form:hidden path="trade" value="取款"/><br>
     	<form:hidden path="datatime" id="datetime"/><br>
        <table width="0" border="0" cellpadding="0">
          <tr>
            <td>当前余额</td>
            <td><label for="textfield"></label>
            <form:input id="textfield" path="balance" value="${trade.balance }"/></td>
          </tr>
          <tr>
            <td>用户账户</td>
            <td><label for="textfield2"></label>
            <form:input path="userno" id="textfield" value="${trade.userno }"/></td>
          </tr>
          <tr>
            <td>请输入取款金额</td>
          ...
          <tr>
            <td><input type="submit" name="button" id="button" value="取款" /></td>
